...
@Component({
  selector: 'app-shukka-schedule',
  templateUrl: './shukka-schedule.component.html',
  styleUrls: ['./shukka-schedule.component.scss']
})
export class ShukkaScheduleComponent implements OnInit {
  ...
  populateData() {
    ...
    this.forecastService.getShukkaForcast(this.viewDate.getFullYear(), this.viewDate.getMonth(), this.selectedPatternId).subscribe(data => {
